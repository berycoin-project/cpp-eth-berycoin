...
#include "genesis/berycoinMainNetwork.cpp"
#include "genesis/berycoinTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::berycoinMainNetwork: return c_genesisInfoBerycoinMainNetwork;
	case Network::berycoinTestNetwork: return c_genesisInfoBerycoinTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::berycoinMainNetwork: return c_genesisStateRootBerycoinMainNetwork;
	case Network::berycoinTestNetwork: return c_genesisStateRootBerycoinTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
